...
class SProductAvailibilitySKUController extends Controller {
    ...
    public function __invoke() {
        ...
        if ($viewData) {
            ...
            if($s_product_availibility) {
                return view('sales.product_availibility_sku', ['sales_access'=>$sales_access, 'business_report_access'=>$business_report_access, 'dealer_access'=>$dealer_access, 'product_access'=>$product_access, 'validation_access'=>$validation_access, 'userName'=>$viewData['userName'], 'userID'=>$userID, 'powerBiEmail'=>$powerBiEmail, 'security_roles_clean'=>$security_roles_clean, 'sales_product'=>true, 'product2'=>true]);
            } else {
